...
public class ProsesData extends javax.swing.JFrame {
    ...
    public void tabelModelNormalisasi(){
       ...
       tabelNormalisasi.addColumn("Nama Produk");
       tabelNormalisasi.addColumn("Spect");
       tabelNormalisasi.addColumn("Software");
       tabelNormalisasi.addColumn("Hardware");
       tabelNormalisasi.addColumn("Service");
    ...
    public  void normalisasi(){
        ...
        try{
            ...
            ResultSet res2 = conn.ambilData("select * from tbl_kriteria, tbl_bobot");
            tabelModelNormalisasi();
            
            while (res2.next()){
                tabelNormalisasi.addRow(new Object[]{res2.getString("nama"),
                    (res2.getFloat("b1") * Float.valueOf(res2.getFloat("C1"))),
                    (res2.getFloat("b2") * Float.valueOf(res2.getFloat("C2"))),
                    (res2.getFloat("b3") * Float.valueOf(res2.getFloat("C3"))),
                    (res2.getFloat("b4") * Float.valueOf(res2.getFloat("C4"))),
                    });
            }
        } catch (SQLException ex){
            JOptionPane.showMessageDialog(this, ex);
